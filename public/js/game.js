...
class Ball {
    ...
    detachFromPlayer() {
        ...
        if (this.attachedPlayer?.getPowerShot()) {
            this.powerShot = true;
            this.powerShotType = PowerShotType_1.PowerShotUtilities.getPowerShotType(this.attachedPlayer.colorIndex);
            speedFactor = PowerShotType_1.PowerShotUtilities.getSpeedFactor(this.powerShotType);
        }
    ...
    shouldCancelOnLowSpeed() {
        if (!this.powerShot || this.powerShotType === null) {
            return true;
        }
        return PowerShotType_1.PowerShotUtilities.shouldCancelOnLowSpeed(this.powerShotType);
    }
    resetPowerShot() {
        this.powerShot = false;
        this.powerShotType = null;
...
class PowerShotUtilities {
    ...
    static shouldCancelOnLowSpeed(powerShotType) {
        switch (powerShotType) {
            case PowerShotType.FIRE:
                return true;
            case PowerShotType.ELECTRIC:
...
class BouncingPowerShotCollisionStrategy extends AbstractCollisionStrategy_1.AbstractCollisionStrategy {
    ...
    apply(gameWorld) {
        gameWorld.players
            ...
            .forEach(player => {
            if (MovementPoint_1.MovementPoint.areTouching(gameWorld.ball.movementPosition, player.movementPosition)) {
                const middlePoint = new Point_1.Point((gameWorld.ball.movementPosition.position.x + player.movementPosition.position.x) / 2, (gameWorld.ball.movementPosition.position.y + player.movementPosition.position.y) / 2);
