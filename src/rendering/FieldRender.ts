...
export class FieldRender {
    ...
    public render (gameWorld : GameWorld) {
        ...
        this.backgroundContext.clearRect(0, 0, 
            this.backgroundContext.canvas.width, this.backgroundContext.canvas.height);

        this.backgroundContext.lineWidth = 1;
		this.backgroundContext.fillStyle = 'rgba(255, 255, 255, 0)';
        this.backgroundContext.save();

		this.backgroundContext.fillRect(this.gameConfigs.width / 2, 
    ...
    private renderBackground() : void {
		...
		this.backgroundContext.drawImage(this.fieldImage, 
            this.gameConfigs.getFieldXOffset(), 0, 
            this.gameConfigs.getFieldWidth(), this.gameConfigs.getFieldHeight());
		
        this.backgroundContext.drawImage(this.goalImage, 
            0, this.gameConfigs.getGoalYOffset(), 
            this.gameConfigs.getFieldXOffset(), this.gameConfigs.getGoalHeight());
    ...
    private renderBorder() : void {
        ...
        this.backgroundContext.fillRect(this.gameConfigs.getFieldXOffset() - this.borderSize, 
            0, 
      	...
      	this.backgroundContext.fillRect(this.gameConfigs.getFieldXOffset() - this.borderSize, 
            ...
            // TODO da rivedere
            this.gameConfigs.getSubstitutionOffsetX() - this.gameConfigs.getFieldXOffset() + this.borderSize,
            this.borderSize);
        ...
        this.backgroundContext.fillRect(this.gameConfigs.getFieldXOffset() - this.borderSize, 
      	...
      	this.backgroundContext.fillRect(this.gameConfigs.getFieldXOffset() - this.borderSize, 
            ...
            this.borderSize, 
            this.gameConfigs.getGoalYOffset() + this.borderSize);
      	this.backgroundContext.fillRect(- this.borderSize, 
            this.gameConfigs.getGoalYOffset() - this.borderSize, 
      	...
      	this.backgroundContext.fillRect(- this.borderSize, 
            ...
            this.gameConfigs.getFieldXOffset() + this.borderSize, 
            this.borderSize);
      	this.backgroundContext.fillRect(0, 
            this.gameConfigs.getGoalYOffset() - this.borderSize, 
            this.borderSize, 
            this.gameConfigs.getGoalHeight() + this.borderSize * 2);

        this.backgroundContext.fillRect(this.gameConfigs.getFieldXOffset() + this.gameConfigs.getFieldWidth(), 
            - this.borderSize, 
            this.borderSize, 
            this.gameConfigs.getGoalYOffset() + this.borderSize);
      	this.backgroundContext.fillRect(this.gameConfigs.getFieldXOffset() + this.gameConfigs.getFieldWidth(), 
            this.gameConfigs.getGoalYOffset() + this.gameConfigs.getGoalHeight(), 
            this.borderSize, this.gameConfigs.getGoalYOffset() + 
            this.borderSize);
      	this.backgroundContext.fillRect(this.gameConfigs.getFieldXOffset() + this.gameConfigs.getFieldWidth(), 
            this.gameConfigs.getGoalYOffset() - this.borderSize, 
      	...
      	this.backgroundContext.fillRect(this.gameConfigs.getFieldXOffset() + this.gameConfigs.getFieldWidth(), 
            ...
            this.gameConfigs.getFieldXOffset(), 
            this.borderSize);
      	this.backgroundContext.fillRect(this.gameConfigs.getFieldXOffset()*2 + this.gameConfigs.getFieldWidth() - this.borderSize, 
            this.gameConfigs.getGoalYOffset() - this.borderSize, 
            this.borderSize, 
            this.gameConfigs.getGoalHeight() + this.borderSize*2);		
    }
    ...
    private renderGoalPosts() : void {
		...
		this.backgroundContext.arc(this.gameConfigs.getFieldXOffset(), 
            this.gameConfigs.getGoalYOffset(), 
            this.gameConfigs.getGoalPostRadius(), 0, 2 * Math.PI, false);
        ...
        this.backgroundContext.beginPath();
		this.backgroundContext.arc(this.gameConfigs.getFieldXOffset() + this.gameConfigs.getFieldWidth(), 
            this.gameConfigs.getGoalYOffset(), 
            this.gameConfigs.getGoalPostRadius(), 0, 2 * Math.PI, false);
		this.backgroundContext.closePath();
		this.backgroundContext.fill();
    ...
    private renderAthleticTrack() : void {
        this.backgroundContext.drawImage(this.trackFieldImage, 
            this.gameConfigs.getFieldXOffset(), 
