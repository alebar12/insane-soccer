...
class CpuMovementStrategy {
    ...
    tryKick(player, ball) {
        if (ball.movementPosition.position.x < player.movementPosition.position.x) {
            ...
            if (y >= this.gameConfigs.goalYOffset - offset &&
