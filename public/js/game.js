...
class Player {
    ...
    adjustSpeedToDestinationPoint(deltaMs) {
        ...
        if (Point_1.Point.getDistance(projectedPosition, targetPosition) <
            this.reachedDistanceTolerance) {
...
class CpuMovementStrategy {
    ...
    rotateCpu(player, deltaMs) {
        if (this.rotateDirection === 0) {
            ...
            this.rotateAngle = ((Math.random() * (Math.PI / 50 - Math.PI / 100)) + Math.PI / 100) * 0.07;
        }
