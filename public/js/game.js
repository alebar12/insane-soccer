...
class Player {
    ...
    static createHumanPlayer(gameConfigs) {
        return new Player(gameConfigs, false, false, PlayerSide_1.PlayerSide.LEFT, 1);
    }
...
class PlayerPowerShotRender {
    ...
    renderElectricPowerShot(player, _electricPowerShot) {
        this.gameContext.save();
        const gradient = this.gameContext.createRadialGradient(player.movementPosition.position.x, player.movementPosition.position.y, this.gameConfigs.playerSizeWithBorder / 5, player.movementPosition.position.x, player.movementPosition.position.y, this.gameConfigs.playerSizeWithBorder);
        gradient.addColorStop(0, "#FFFFFF");
        gradient.addColorStop(1, "transparent");
        this.gameContext.beginPath();
        this.gameContext.arc(player.movementPosition.position.x, player.movementPosition.position.y, this.gameConfigs.playerSizeWithBorder, 0, 2 * Math.PI, false);
        this.gameContext.closePath();
