...
class ElectricPowerShot {
    update(_deltaMs) { }
    shouldRender(player) {
        return player.colorIndex == 1 && player.getPowerShot() && player.playerStatus == PlayerStatus_1.PlayerStatus.NORMAL;
    }
}
...
class FirePowerShot {
    ...
    update(deltaMs, player) {
        ...
        if (this.lastAddedDeltaTime >= this.interval && player.getPowerShot() &&
            player.colorIndex == 0 && player.playerStatus == PlayerStatus_1.PlayerStatus.NORMAL) {
...
class PowerShotWrapper {
    constructor(gameConfigs) {
        ...
        this.powerShots.push(new ElectricPowerShot_1.ElectricPowerShot());
    }
    update(deltaMs, player) {
...
class MainRender {
    constructor(gameConfigs, domHandler, assetLoader) {
        ...
        this.renders.push(new PlayerPowerShotRender_1.PlayerPowerShotRender(domHandler.gameContext, assetLoader));
...
class PlayerPowerShotRender {
    constructor(gameContext, assetLoader) {
        this.cellsPerRow = 4;
    ...
    renderElectricPowerShot(_electricPowerShot) { }
}
